...
Hoy vamos a hacer un pequeño tutorial sobre Kotlin targeteando a JavaScript.
Vamos a ver cómo crear un proyecto de JavaScript, cómo probarlo,
cómo añadir librerías externas y cómo comunicarnos con JavaScript.
En este artículo veremos cómo engancharlo en el lado de cliente,
